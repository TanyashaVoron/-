...
def MPE_f(x):
    ...
    """
    return math.log(1.12 / (1 + math.sin(x)))
...
# TODO 6. Метод простой итерации: корень -> 0.0574797, количество итераций -> 163
...
6. Метод простой итерации: корень -> 0.0574797, количество итераций -> 163
"""
